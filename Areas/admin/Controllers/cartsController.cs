...
namespace do_an_web.Areas.admin.Controllers
{
    public class cartsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_cart,id_products,images,price,quantity")] cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_cart,id_products,images,price,quantity")] cart cart)
        {
            if (ModelState.IsValid)
            {
